...
| 19 | **Kiểm thử và bằng chứng** — 232 backend tests, coverage 67,54%; 25 frontend tests; Ruff, TypeScript, ESLint, release guard và build pass ngày 22/07/2026 | Bảng từ `../launch-readiness.md` | Nêu mục tiêu 70% chưa đạt và browser chưa được chạy lại; không biến “pass unit test” thành khẳng định không còn lỗi. | 1:05 |
