...
| 12 | **Cấu trúc bữa và ràng buộc** — sáng 1 món; trưa/tối = tinh bột + mặn + rau/canh; ngân sách/dị ứng/dữ liệu là cứng | Bảng hard/soft constraints | Mục tiêu macro là tối ưu mềm; vi phạm ngân sách hay dị ứng thì không được trả plan hợp lệ. | 1:15 |
...
| 19 | **Kiểm thử và bằng chứng** — 189 backend tests; TypeScript, ESLint, release guard, build pass ngày 13/07/2026 | Bảng từ `../launch-readiness.md` | Nêu cả 3 warning không gây fail; không biến “pass unit test” thành khẳng định không còn lỗi. | 1:05 |
