# 09 — AI provider và nhật ký

## Mục tiêu

Tạo cấu hình provider ở trạng thái draft, kiểm tra structured output, kích hoạt/tắt an toàn và đọc nhật ký vận hành 30 ngày.
...
7. Trong **Nhật ký AI — lưu 30 ngày**, đọc feature, model, trạng thái và latency. Chỉ mở **Chi tiết** khi cần điều tra và được phép xem nội dung; chọn **Dọn log quá hạn** để xóa log đã hết hạn.
...
- Base URL được backend kiểm tra để giảm rủi ro truy cập địa chỉ metadata/nội bộ nguy hiểm; không dùng URL không rõ nguồn.
- Log chi tiết có thể chứa câu hỏi/response của User; áp dụng quyền tối thiểu và không đưa lên slide.
